...
kbd.add_layer :default, %i[
  ...
  GRAVE_LCTL   KC_A      KC_S      KC_D      KC_F      KC_G      KC_H      KC_J      KC_K      KC_L      KC_SCOLON KC_QUOT   KC_NONUS_HASH   KC_ENT   KC_PGDN
  KC_LSFT   XXXXXXX   KC_Z      KC_X      KC_C      KC_V      KC_B      KC_N      KC_M      KC_COMM   KC_DOT    KC_SLSH   KC_INT1   KC_RSFT   KC_DEL
  FUNC   KC_GRAVE   KC_LGUI   XXXXXXX   BSPC_LALT   SPC_FUNC    XXXXXXX    HENK_FUNC   ENT_RALT KC_LGUI   KC_FUNC   KC_LEFT   KC_DOWN   KC_UP     KC_RGHT
]

kbd.add_layer :func, %i[
  KC_GRAVE  KC_F1     KC_F2     KC_F3     KC_F4     KC_F5     KC_F6     KC_F7     KC_F8     KC_F9     KC_F10    KC_F11    KC_F12    XXXXXXX   KC_DEL
...
kbd.define_mode_key :LNG1_FUNC, [ :KC_LANG1, :func, 150, nil ]
kbd.define_mode_key :LNG2_FUNC, [ :KC_LANG2, :func, 150, nil ]
kbd.define_mode_key :SPC_FUNC, [ :KC_SPC, :func, 150, nil ]
kbd.define_mode_key :GRAVE_LCTL, [ :KC_GRAVE, :KC_LCTL, 150, nil ]
kbd.define_mode_key :ENT_RALT, [ :KC_ENT, :KC_RALT, 150, nil ]
kbd.define_mode_key :BSPC_LALT, [ :KC_BSPC, :KC_LALT, 150, nil ]
kbd.define_mode_key :HENK_FUNC, [ :KC_INT4, :func, 150, nil ]
